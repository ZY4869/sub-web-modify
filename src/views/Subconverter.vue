  ...
  <div>
    <el-row style="margin-top: 10px">
      <el-col>
        <el-card>
          <div slot="header">
            <div style="text-align:center;font-size:15px">订阅转换</div>
          </div>
          <el-container>
          ...
          <el-form label-position="left">
            <el-form-item prop="uploadScript">
              <el-input
                  ...
                  placeholder="该功能默认停用，如需使用请部署兼容的脚本上传接口。"
                  type="textarea"
                  :autosize="{ minRows: 15, maxRows: 15}"
                  maxlength="50000"
                  show-word-limit
  ...
  data() {
    return {
      ...
      options: {
        ...
        shortTypes: {
          "短链服务 1": "https://v1.mk/short",
          "短链服务 2": "https://d1.mk/short",
          "短链服务 3": "https://dlj.tf/short",
          "短链服务 4": "https://suo.yt/short",
          "短链服务 5": "https://sub.cm/short",
        },
        customBackend: {
